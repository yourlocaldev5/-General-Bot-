...
async function handleSetup(interaction, guild, client) {
    ...
    const verifyEmbed = createEmbed({
        title: "Verification",
        description: "To have full access to the server, please verify using the button below.",
        color: "#242429",
        image: "https://cdn.discordapp.com/attachments/1495601343610748978/1502742574845263952/image.png?ex=6a00d195&is=69ff8015&hm=57abd28103710cad131611fa4a5a6558937ca5844ab7d621f48339ea9d5546a8&"
    });
